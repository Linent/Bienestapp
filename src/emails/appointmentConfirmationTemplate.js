...
// Recibe: { student, advisor, topic, scheduleDate }
module.exports = ({ student, advisor, topic, scheduleDate }) => `
<!DOCTYPE html>
<html lang="es">
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    <div style="background: linear-gradient(180deg, #aa1916 0%, #ffffff 100%); width: 100%; background-color: #e3e3e3;">
      <div style="padding: 20px 10px;">
        ...
        <!-- Contenido Principal -->
        <div style="background-color: #ffffff; padding: 20px; text-align: center;">
          <h1>¡Asesoría agendada con éxito!</h1>
          <h4>Hola ${student.name},</h4>
          <p>Te confirmamos que tu asesoría académica ha sido <b>agendada correctamente</b>.</p>
          <div style="margin: 16px 0;">
            <p><b>Asesor:</b> ${advisor.name}</p>
            <p><b>Tema:</b> ${topic}</p>
            <p><b>Fecha y hora:</b> ${scheduleDate.toLocaleString("es-CO", { dateStyle: "full", timeStyle: "short" })}</p>
          </div>
          <p>Si necesitas cancelar o reagendar, accede a la plataforma:</p>
          <p style="margin-bottom: 30px;">¡Te esperamos en tu asesoría!</p>
          <p><b>Atentamente,</b></p>
